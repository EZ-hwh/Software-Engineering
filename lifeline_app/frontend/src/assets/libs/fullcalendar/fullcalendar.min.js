    ...
    return (function(t) {
            ...
            return (
              ...
              (t.prototype.buildNewDateProfile = function(t, e) {
                ...
                return (
                  ...
                  o &&
                    ((n = e.applyTimezone(n)), r && (r = e.applyTimezone(r))),
                  !r &&
                  ...
                  for (
                    ...
                    if (u) {
                      for (
                        ...
                        (g = i('<td class="fc-more-cell"/>').attr(
                          "rowspan",
                          p
                        )),
                          (l = d[f]),
            ...
            return (
              ...
              (t.prototype.isFootprintAllowed = function(t, e, n, o, s) {
                ...
                if (
                  ...
                  return !1;
                if (
                  ((l = this.collectOverlapEventFootprints(e, t)), !1 === o)
                ) {
              ...
              (t.prototype.buildCurrentBusinessFootprints = function(t) {
                ...
                return i
                  ? this.eventInstancesToFootprints(i.eventInstances)
                  : [];
              }),
                  ...
                  this.dateProfile.activeUnzonedRange.containsDate(t)
                    ? (i.push("fc-" + a.dayIDs[t.day()]),
                      ...
                      t.isSame(n, "day")
                        ? (i.push("fc-today"),
                          !0 !== e &&
                            i.push(r.calendar.theme.getClass("today")))
                        : t < n
                        ? i.push("fc-past")
                        : i.push("fc-future"))
          ...
          c = (function(t) {
            ...
            return (
              ...
              (e.prototype.computeEventDropMutation = function(t, e, n) {
                var r = new o.default();
                return (
                  r.setDateMutation(this.computeEventDateMutation(t, e)), r
                );
              }),
              (e.prototype.computeEventDateMutation = function(t, e) {
                ...
                return (
                  t.isAllDay !== e.isAllDay &&
                    ((a = !0),
                    e.isAllDay ? ((u = !0), i.stripTime()) : (l = !0)),
      ...
      function(t, e, n) {
        function r(t, e) {
          ...
          for (n = 0; n < e.length; n++)
            if (
              ((r = e[n]), r.leftCol <= t.rightCol && r.rightCol >= t.leftCol)
            )
              return !0;
          return !1;
        }
